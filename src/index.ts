...
function asturlab(position: Coordinates, options: {rhumb?: boolean} = {}): number {
    let bearing;
...
// adapted from turfjs
function rhumbBearing(from: Coordinates): number{
...
// adapted from turfjs
function greatCircleBearing(from: Coordinates): number {
